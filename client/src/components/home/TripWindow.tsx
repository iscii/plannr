...
export default function TripWindow({
  ...
  return (
    <aside
      id="tripWindow"
      className={`hidden lg:block trip top-inherit left-inherit load-slide-right fixed right-12 z-20 mr-2 ${currentTrip.length < 3 ? "h-fit" : "h-4/5"} w-1/3 rounded-lg pb-12 pl-10 opacity-90`}
    >
